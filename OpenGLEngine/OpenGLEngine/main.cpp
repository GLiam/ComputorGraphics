...
//********************************************************************************************//
		...
		m_light.diffuse = { 0.5f, 0.8f, 1};
		m_secondLight.diffuse = { 1, 0.2f, 0.9f };
		m_thirdLight.diffuse = { 0.8f, 0, 0.3f };
...
//********************************************************************************************//
	...
	void update() override
	{
		...
		m_light.direction = glm::normalize(vec3(glm::cos(time * 8), glm::sin(time * 2), 0));
		m_secondLight.direction = glm::normalize(vec3(glm::cos(time * 16), glm::sin(time * 8), 0));
		m_thirdLight.direction = glm::normalize(vec3(glm::cos(time * -16), glm::sin(time * -8), 0));
